...
if not opt.evaluate_all:
    ...
    test_dataloader = DataLoader(ImageDataset(dataset_dir, transforms_=transforms_), 
    ...
    for i, batch in enumerate(test_dataloader):
        ...
        # Save image files
        save_image( fake_A, os.path.join(test_output_path, 'B/%04d.png' % (i+1)) )
        save_image( fake_B, os.path.join(test_output_path, 'A/%04d.png' % (i+1)) )
