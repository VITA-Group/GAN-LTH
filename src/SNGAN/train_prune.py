...
import datasets
import random
from functions import train, train_kd, validate, LinearLrDecay, load_params, copy_params
from utils.utils import set_log_dir, save_checkpoint, create_logger, pruning_generate, see_remain_rate, rewind_weight
...
def main():
    ...
    for epoch in tqdm(range(int(start_epoch), int(args.max_epoch)), desc='total progress'):
        ...
        if not args.use_kd_D:
            ...
            train_kd(args, gen_net, dis_net, orig_dis_net, gen_optimizer, dis_optimizer,
