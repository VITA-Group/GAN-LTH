...
import datasets
from functions import VGGFeature, gram_matrix, validate, soft_sign, show_sparsity, create_dir, LambdaLR, fourD2threeD, calculate_metrics
...
for epoch in range(int(start_epoch), int(args.max_epoch)):
    ...
    if epoch % 5 == 0 or epoch == int(args.max_epoch)-1:
        ...
        gen_img_big = validate(fixed_z, G)
        soft_gt_img_big = validate(fixed_z, G0)
